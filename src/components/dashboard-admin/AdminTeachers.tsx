        ...
        {createdTeacherAccount ? (
          <div className="mb-4 rounded-xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-sm text-emerald-700">
            ...
            <p className="mt-2 text-xs leading-6">
              Email: {createdTeacherAccount.email} | Password:{" "}
        ...
        {importResult ? (
          ...
          >
            ...
            {importResult.summary.importedRows ? (
              <p className="mt-2 text-xs leading-6">
                Password awal guru hasil import mengikuti pola `guruNNN` dari
                ...
                {importResult.details.slice(0, 6).map((detail) => (
                  ...
                  >
                    {detail.status === "imported"
                      ? `Baris ${detail.rowNumber}: ${detail.name} -> ${detail.email} / ${detail.generatedPassword}`
        ...
        <div className="mb-6 flex flex-col gap-3 md:flex-row md:flex-wrap">
          <div className="w-full md:flex-1">
            <Input
              ...
              placeholder="Cari nama, mapel, cabang, jadwal, atau kelas..."
            />
          </div>
                ...
                <div className="space-y-2">
                  ...
                  {!isEditing ? (
                    <p className="text-xs leading-5 text-slate-500">
                      Jika dikosongkan, sistem akan membuat email login guru
