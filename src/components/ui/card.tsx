...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-[28px] border border-slate-200/80 bg-white/94 shadow-[0_18px_42px_-28px_rgba(15,23,42,0.18),0_12px_26px_-22px_rgba(249,115,22,0.18)] backdrop-blur-sm",
        className,
      )}
      {...props}
    />
